#ifndef USB_usb_xmega_h__
#define USB_usb_xmega_h__
...
// TODO: need to somehow allocate two bytes after the endpoint table for frame number
// An "overkill" way is to allocate another 16 bytes for an extra "endpoint"
//   that would cover the two bytes.
...
#define USB_ENDPOINTS(NUM_EP) \
  ...
  USB_EP_pair_t usb_xmega_endpoints[(NUM_EP)+2] GCC_FORCE_ALIGN_2;
